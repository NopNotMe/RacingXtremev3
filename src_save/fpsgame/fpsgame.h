...
namespace server
{
    ...
    struct gamestate : fpsstate
    {
        ...
        float effectiveness;
        bool throwingnade; //racing

        // remod
        remod::extstate ext;

        gamestate() : state(CS_DEAD), editstate(CS_DEAD), lifesequence(0), throwingnade(false) {}
    ...
    struct raceghost
    {
      bool enabled, allowspec;
      raceghost() : enabled(false), allowspec(true) {}
      };
